...
public class DeliberativeTemplate implements DeliberativeBehavior
{
    ...
    /**
     * Looks for all reachable nodes from the node given as argument. The function will create all the nodes with the
     * relevant information and aggregate them in a list that will be returned.
     *
